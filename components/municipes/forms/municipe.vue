...
export default {
    ...
    methods: {
        ...
        validateForm() {
            ...
            let filledFields = this.full_name != '' 
        ...
        async saveMunicipe() {
            ...
            if (this.validateForm()) {
                ...
                return await this.idEdit ? this.$axios.$put(`${this.$axios.defaults.baseURL}/municipes/${this.idEdit}`, formData)
