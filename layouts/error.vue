<template>
  <div class="error-page" :class="cls">
    <div class="error-page__message">
      <h1
        class="error-page__message__title"
        v-if="code === 404 || code === 500"
      >
        {{ title }}
      </h1>
  ...
  methods: {
    mountError() {
      ...
      if (this.error.statusCode === 500) {
        ...
        this.message =
          "Ocorreu um erro inesperado no servidor. Entre em contato com administrador do sistema.";
        this.cls = "error-500";
      }
    },
  },
